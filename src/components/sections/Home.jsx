      ...
      <RevealOnScroll>
        <div className="text-center z-10 px-4">
          ...
          <p className="text-gray-400 text-lg mb-8 max-w-lg mx-auto">
            I am a full-stack developer who lovers crafting clean, scalable web
            applications. My goal is to build solution that offer both
            exceptional perfomance and a delightful user experiance.
          </p>
          <div className="felx justify-center space-x-4">
            <a
              href="#projects"
